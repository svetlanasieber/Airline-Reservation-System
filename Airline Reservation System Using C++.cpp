...
public://public member functions
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        if((src==1 && dest==2) || (src==2 && dest==1))//condition
        {
            ...
            cout << "\1.Saucer(1)\t08:00\t\t11:05\t\t$100\t\tRefundable\n";
            cout << "\2.Far Flyer(2)\t14:00\t\t17:05\t\t$100\t\tRefundable\n";
            cout << "\3.Air Speed(3)\t19:00\t\t22:05\t\t$100\t\tRefundable\n";
        }
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Saucer(1)\t08:00\t\t11:05\t\t$200\t\tRefundable\n";
            cout << "\2.Far Flyer(2)\t14:00\t\t17:05\t\t$250\t\tRefundable\n";
            cout << "\3.Air Speed(3)\t19:00\t\t22:05\t\t$300\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Saucer(1)\t08:00\t\t11:05\t\t$140\t\tRefundable\n";
            cout << "\2.Far Flyer(2)\t14:00\t\t17:05\t\t$150\t\tRefundable\n";
            cout << "\3.Air Speed(3)\t19:00\t\t22:05\t\t$180\t\tRefundable\n";
        }
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
            ...
            cout << "\1.Saucer(1)\t08:00\t\t11:05\t\t$200\t\tRefundable\n";
            cout << "\2.Far Flyer(2)\t14:00\t\t17:05\t\t$150\t\tRefundable\n";
            cout << "\3.Air Speed(3)\t19:00\t\t22:05\t\t$200\t\tRefundable\n";
        }
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
         {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Saucer(1)\t08:00\t\t11:05\t\t$180\t\tRefundable\n";
            cout << "\2.Far Flyer(2)\t14:00\t\t17:05\t\t$50\t\tRefundable\n";
            cout << "\3.Air Speed(3)\t19:00\t\t22:05\t\t$150\t\tRefundable\n";
        }
    ...
    {   cout << "\nEnter your choice" << endl;
        ...
        switch(choice) // switch case
        {
          case 1://condition
                ...
                cout << "Saucer"<<endl;
                strcpy(f_d,"Saucer");//copy to string
          ...
          case 2://condition
                cout << "\nFlight selected:"<<endl;
                cout << "Far Flyer"<<endl;
                strcpy(f_d,"Far Flyer");//copy to string
          ...
          case 3://condition
                cout << "\nFlight selected:" << endl;
                cout << "Air Speed" << endl;
                strcpy(f_d,"Air Speed");//copy to string
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$250\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$215\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$240\tRefundable\n";
        }

        else if((srci==1 && desti==4) || (srci==4 && desti==1))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$255\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$213\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$246\t\tRefundable\n";
        }
        ...
        else if((srci==1 && desti==5) || (srci==5 || desti==1))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$250\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$290\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$420\tRefundable\n";
        }

        else if((srci==2 && desti==3) || (srci==3 && desti==2))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$170\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$140\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$170\tRefundable\n";
        }

        else if((srci==2 && desti==4) || (srci==4 && desti==2))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$100\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$120\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$250\tRefundable\n";        }

        else if(srci==2 && desti==5 || (srci==5 && desti==2))//condition
        {
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.Vistara(1)\t10:00\t\t14:05\t\t$140\tRefundable\n";
            cout << "\2.Fly Dubai(2)\t14:00\t\t18:05\t\t$120\tRefundable\n";
            cout << "\3.Emirates(3)\t18:00\t\t22:05\t\t$140\tRefundable\n";
